...
const Certs: React.FC = () => {
  ...
  const webCerts: CertificateItem[] = [
    ...
    { image: certs.sv, url: 'https://coursera.org/verify/9O7BBKQOHJZW', altText: 'Scrimba Learn Vite Certificate' },
    ...
    { image: certs.brd_vue, url: 'https://coursera.org/verify/7YYOOCGWRBKN', altText: 'Board Infinity VueJS Fundamentals Certificate' },
