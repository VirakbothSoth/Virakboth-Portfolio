...
const Certs: React.FC = () => {
    ...
    const pyCerts: CertificateItem[] = [
        ...
        {
            image: certs.ib_pyda,
            url: "https://coursera.org/verify/8EMCJCAXCOVP",
            altText: "IBM Python for Data Science and AI Badge",
        },
        {
            image: certs.ib_pyai,
            url: "https://coursera.org/verify/7CJR0MJW3HH5",
    ...
    const aiCerts: CertificateItem[] = [
        ...
        },
        {
            ...
            altText:
                "Scrimba Build AI Apps with ChatGPT and Dall-E Certificate",
        },
        {
            image: certs.scd,
    ...
    return (
        <section className="p-80">
            <div className="container mx-auto cert-section">
                ...
                <p>
                    <em>
                        I know, that's a lot, so I exclude the less important
                        ones!
                    </em>
                </p>
                <div>
