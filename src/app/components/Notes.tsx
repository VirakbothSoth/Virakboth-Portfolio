        ...
        <section className="py-40">
            <div className="container mx-auto">
                ...
                <div className="text-left flex flex-wrap justify-center gap-6">
                    <div className="note-card">
                        ...
                        <div className="bg-gray-800 rounded-lg">
                            <div className="journey-container">
                                <div className="pl-3">
                                    <p>
                                        I want to get a .dev domain for my
                                        portfolio, but I don't think it's worth
                                        it right now.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="note-card">
                        <h3 className="text-3xl font-bold mb-[50px]">Tab 1</h3>
                    ...
                    <div className="note-card">
                        ...
                        <div className="bg-gray-800 rounded-lg">
                            {state ? (
                                <div className="p-5">
                                    <p>
                                        Hello, if you like my portfolio (or me),
                                        you can give me a star on github!
                                    </p>
                                </div>
                            ) : (
                                <div className="p-5">
