                ...
                <div className="text-left grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="project-card">
                        ...
                        <div className="project-content">
                            ...
                            <p className="text-xl">
                                A simple password generator website, nothing
                                else
                            </p>
                            <div className="flex gap-4">
                                <a
                    ...
                    <div className="project-card">
                        ...
                        <div className="project-content">
                            ...
                            <p className="text-xl">
                                This includes various projects built for
                                freecodecamp.
                            </p>
                            <div className="flex gap-4">
                                <a
                    ...
                    <div className="project-card">
                        ...
                        <div className="project-content">
                            ...
                            <p className="text-xl">
                                This includes various projects built for the
                                odin project.
                            </p>
                            <div className="flex gap-4">
                                <a
                    ...
                    <div className="project-card">
                        ...
                        <div className="project-content">
                            ...
                            <p className="text-xl">
                                One of my 1st Coding Projects, some are school
                                projects
                            </p>
                            <div className="flex gap-4">
                                <a
